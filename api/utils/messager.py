...
from dl_power.utils.utils import DATE_FORMAT

FEISHU_URL = 'https://open.feishu.cn/open-apis/bot/v2/hook/171367f4-f521-4e13-a7c7-36ff400dfe5a'
FEISHU_SECRET = 'Qn5xMR3tLC76q7jbCPovYc'

PHONE_WEIJIAQI = '18101216629'
...
class Messenger(object):
    ...
    def collect(self,
        ...
        if not run_version_time:
            run_version_time = datetime.now().strftime(DATE_FORMAT)
        ...
        msg_str = '{}-{} {} {} {} {} {} {}'.format(
            ...
            self.run_time_type,
            region,
            task_mapping.get(task, '其他'),
            span_day_mapping.get(span_day, '其他'),
            other_text,
            failure,
            cur_time,
        )
